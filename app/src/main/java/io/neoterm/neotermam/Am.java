...
import io.neoterm.neotermam.logger.Logger;
import io.neoterm.neotermam.reflection.ReflectionUtils;
...
public class Am extends BaseCommand {
    ...
    public static final String LOG_TAG = "NeoTermAm";
    ...
    */
    ...
    int parseUserArg(String arg, boolean getActualUser) {
        ...
        if ("all".equals(arg)) {
            ...
            // - https://github.io.neoterm/NeoTermAm/issues/11
